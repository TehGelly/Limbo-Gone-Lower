...
float4 RenderObjectPS(float4 uv0 : TEXCOORD0, float4 color : TEXCOORD6, float4 specular : TEXCOORD7) : COLOR0
{ 
#if defined(ORIGO_MAC)
	float4 pixel = tex2Dbias(TextureSampler, uv0.xy, uv0.w) * color;
#else
